...
**Public URL (production):** https://breezydrive.app/legal/privacy
...
- **No third-party tracking.** We do not request App Tracking
  ...
  joining). See `BreezyDrive/Domain/PermissionPolicy.swift` and
  `BreezyDrive/Resources/PrivacyInfo.xcprivacy` for the source-of-truth
  declarations.
